...
REQUIRED_FILES=(
	...
	"scripts/dev/orchestration-lib.mjs"
	"scripts/dev/autopilot-work.mjs"
	...
	"scripts/dev/orchestrate-work.mjs"
	"scripts/dev/list-orchestration-work.mjs"
	"scripts/dev/check-orchestration-work.mjs"
...
require_text "docs/ORCHESTRATION.md" "## Orchestration Model" "orchestration model"
require_text "docs/ORCHESTRATION.md" "## Commands" "orchestration commands"
require_text "docs/ORCHESTRATION.md" "## Optional Autopilot" "orchestration autopilot"

<script lang="ts">
  ...
  import { careStateLabels, growthStageLabels, memoryTierLabels } from '$lib/data/seed';
...
<PageShell>
  <section class="journal-stage">
    <article class="panel journal-board">
      <div class="journal-board__header">
        <div>
          <p class="section-kicker">Return Journal</p>
          <h1 class="section-title">{returnHeadline}</h1>
        </div>

        <div class="chip-row journal-board__stamps">
          {#if returnSummary}
        ...
        <div class="journal-note">
          <div class="journal-note__portrait">
            <div class="journal-polaroid">
              <PixelSprite agent={selectedAgent} size={86} alt={selectedAgent.name} />
            </div>
            <div class="chip-row">
          ...
          <div class="journal-note__body">
            ...
            <div class="journal-next-step">
              ...
              {#if runtimeFocusCheck}
                <p>Nightly distill note: {runtimeFocusCheck}</p>
              {/if}
            </div>
    ...
    <aside class="journal-sidebar">
      <article class="panel journal-care-rail">
        <div class="stack">
          <div>
            ...
            <h2 class="section-title">Who needs attention before the next proof gate.</h2>
          </div>
      ...
      <article class="panel journal-distill-card">
        <div class="stack">
          <div>
            <p class="section-kicker">Nightly Distill</p>
  ...
  <section class="journal-ledgers">
    <article class="panel journal-shelf">
      <div class="stack">
        <div>
          <p class="section-kicker">Keepsake Shelf</p>
          <h2 class="section-title">What this creature is carrying forward.</h2>
        </div>
    ...
    <article class="panel journal-book">
      <div class="stack">
        <div>
          <p class="section-kicker">Focus Notebook</p>
  ...
  <section class="journal-history">
    <div class="journal-history__header">
      <p class="section-kicker">Proof Shelf</p>
...
<style>
  ...
  .journal-board {
    background:
      radial-gradient(circle at top right, rgba(232, 221, 181, 0.3), transparent 32%),
      linear-gradient(180deg, rgba(248, 244, 235, 0.96), rgba(243, 238, 226, 0.92));
  }

  .journal-board__header,
  .journal-history__header {
    display: grid;
    gap: 10px;
  }

  .journal-board__stamps {
    align-items: center;
  }
  ...
  .journal-polaroid {
    ...
    background:
      linear-gradient(180deg, rgba(255, 253, 248, 0.96), rgba(243, 239, 230, 0.92));
    box-shadow: 0 12px 24px rgba(75, 73, 61, 0.08);
  }
  ...
  .journal-distill-card {
    background:
      linear-gradient(180deg, rgba(251, 246, 231, 0.92), rgba(245, 240, 223, 0.9));
  }

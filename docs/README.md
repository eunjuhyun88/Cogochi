...
2. `AGENTS.md`
3. `CLAUDE.md`
4. `docs/MASTER_GAME_SPEC.md`
5. `docs/AGENT_SYSTEM_DESIGN.md`
6. `docs/BATTLEFIELD_DESIGN.md`
7. `docs/VISUAL_WORLD_DESIGN.md`
8. `docs/TECH_ARCHITECTURE.md`
9. `docs/SYSTEM_INTENT.md`
10. `ARCHITECTURE.md`
11. `docs/CONTEXT_ENGINEERING.md`
12. `docs/CONTEXTUAL_RETRIEVAL.md` when the right canonical docs are still unclear
13. `docs/AGENT_FACTORY.md` when creating or revising reusable agents
14. `docs/TOOL_DESIGN.md` when creating or revising reusable tools
15. `docs/AGENT_OBSERVABILITY.md` when work needs runtime evidence or value measurement
16. `docs/CONTEXT_PLATFORM.md` for registry, open-source, or public evaluation work
17. `docs/MULTI_AGENT_COORDINATION.md` when parallel work is possible
18. `docs/ORCHESTRATION.md` when work must be sequenced across dependencies or handoffs
19. `docs/GIT_WORKFLOW.md` when branching, syncing, or merge discipline matters
20. `docs/README.md`
21. the smallest relevant canonical doc subset
...
- `docs/references/`
  ...
  - `docs/references/imported/` stores raw imports and duplicate source dumps
- `agents/`
...
| --- | --- | --- |
| product compass | `CLAUDE.md` | `docs/MASTER_GAME_SPEC.md`, `docs/SYSTEM_INTENT.md` |
| product truth and gameplay scope | `docs/MASTER_GAME_SPEC.md` | `docs/AGENT_SYSTEM_DESIGN.md`, `docs/BATTLEFIELD_DESIGN.md` |
| agent runtime, training loop, memory model | `docs/AGENT_SYSTEM_DESIGN.md` | `docs/TECH_ARCHITECTURE.md`, `docs/SYSTEM_INTENT.md` |
| technical stack and layer ownership | `docs/TECH_ARCHITECTURE.md` | `docs/ENGINEERING.md`, `docs/generated/store-authority-map.md` |
| chart-to-battle grammar | `docs/BATTLEFIELD_DESIGN.md` | `docs/VISUAL_WORLD_DESIGN.md` |
| rendering feel and layout direction | `docs/VISUAL_WORLD_DESIGN.md` | `docs/BATTLEFIELD_DESIGN.md` |
| system intent and invariants | `docs/SYSTEM_INTENT.md` | `CLAUDE.md`, `docs/design-docs/core-beliefs.md` |
...
| product scope and heuristics | `docs/PRODUCT_SENSE.md` | `docs/product-specs/*.md`, `docs/MASTER_GAME_SPEC.md` |

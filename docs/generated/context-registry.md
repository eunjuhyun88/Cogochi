...
- Publish tags: `cogochi-v1, context-kit, judgment-rpg`

## Surfaces

| Surface | Label | Spec | Routes |
| --- | --- | --- | --- |
| `core` | Trainer hub | `docs/product-specs/core.md` | / |
| `raising` | Raising surfaces | `docs/product-specs/raising.md` | /roster, /agent/[id], /lab |
| `field` | Field route | `docs/product-specs/field.md` | /field |
| `proof` | Proof validation | `docs/product-specs/proof.md` | /proof |
| `passport` | Passport booklet | `docs/product-specs/passport.md` | /passport, /passport/[id], /passport/public/[id], /passport/share/[token] |
| `battle` | Battle proof | `docs/product-specs/battle.md` | /battle |
| `journal` | Return journal | `docs/product-specs/journal.md` | /journal |
...
| `docs/product-specs/raising.md` | surface-raising | surface-canonical |
| `docs/product-specs/field.md` | surface-field | surface-canonical |
| `docs/product-specs/proof.md` | surface-proof | surface-canonical |
| `docs/product-specs/passport.md` | surface-passport | surface-canonical |
| `docs/product-specs/battle.md` | surface-battle | surface-canonical |
| `docs/product-specs/journal.md` | surface-journal | surface-canonical |
...
| --- | --- | --- | --- |
| `asset-curator` | researcher | `core` | `agents/asset-curator.json` |
| `autoresearch-director` | planner | `core` | `agents/autoresearch-director.json` |
| `battle-researcher` | implementer | `core` | `agents/battle-researcher.json` |
| `field-loop-builder` | implementer | `core` | `agents/field-loop-builder.json` |
| `implementer` | implementer | `core` | `agents/implementer.json` |
| `memory-tuner` | implementer | `core` | `agents/memory-tuner.json` |
| `planner` | planner | `core` | `agents/planner.json` |
| `raising-ux-shipper` | implementer | `core` | `agents/raising-ux-shipper.json` |
| `reviewer` | reviewer | `core` | `agents/reviewer.json` |
| `runtime-memory-architect` | implementer | `core` | `agents/runtime-memory-architect.json` |
| `ship-reviewer` | reviewer | `core` | `agents/ship-reviewer.json` |

## Tools

| Tool | Scope | Surfaces | Manifest |
| --- | --- | --- | --- |
| `battle-benchmark` | local-command | `core` | `tools/battle-benchmark.json` |
| `change-acceptance` | local-command | `core` | `tools/change-acceptance.json` |
| `context-retrieve` | context-api | `core` | `tools/context-retrieve.json` |
| `coord-claim` | coordination | `core` | `tools/coord-claim.json` |
| `field-loop-eval` | local-command | `core` | `tools/field-loop-eval.json` |
| `openclaw-health` | local-command | `core` | `tools/openclaw-health.json` |
| `proof-readiness` | local-command | `proof` | `tools/proof-readiness.json` |
| `raising-ux-eval` | local-command | `core` | `tools/raising-ux-eval.json` |
| `registry-search` | context-api | `core` | `tools/registry-search.json` |
| `runtime-readiness` | local-command | `core` | `tools/runtime-readiness.json` |
| `scorecard-report` | local-command | `core` | `tools/scorecard-report.json` |

...
- You start from about `4261` tokens instead of `107371` across the broader docs set.
- You can discover `7` surfaces, `11` reusable agents, and `11` reusable tools without replaying chat history.
- Ambiguous tasks can fall back to retrieval over `1382` indexed chunks.
...
| --- | --- | --- |
| Small start bundle | PASS | 4261 tokens vs 107371 tokens across all docs (96% smaller) |
| Discovery works without chat memory | PASS | 7 surfaces, 11 agents, 11 tools |
| Ambiguity has a retrieval escape hatch | PASS | 1382 retrieval chunks across 77 sources |

...
- You start from about `4118` tokens instead of `96188` across the broader docs set.
- You can discover `7` surfaces, `11` reusable agents, and `11` reusable tools without replaying chat history.
- Ambiguous tasks can fall back to retrieval over `1369` indexed chunks.
...
| --- | --- | --- |
| Small start bundle | PASS | 4118 tokens vs 96188 tokens across all docs (95.7% smaller) |
| Discovery works without chat memory | PASS | 7 surfaces, 11 agents, 11 tools |
| Ambiguity has a retrieval escape hatch | PASS | 1369 retrieval chunks across 76 sources |
